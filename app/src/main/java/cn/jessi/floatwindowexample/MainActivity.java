package cn.jessi.floatwindowexample;
...
import top.jessi.floatwindow.draggable.MovingDraggable;
import top.jessi.floatwindow.draggable.SpringBackDraggable;
...
public final class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (viewId == R.id.btn_main_anim) {
            ...
            FloatWindow.with(this)
                    ...
                    .setOnClickListener(android.R.id.message, new FloatWindow.OnClickListener<TextView>() {

                        @Override
                        public void onClick(FloatWindow<?> floatWindow, TextView view) {
                            floatWindow.cancel();
                        }
                    })
                    .show();
            ...
            FloatWindow.with(this)
                    ...
                    .setOnWindowLifecycle(new FloatWindow.OnWindowLifecycle() {
            ...
            FloatWindow.with(this)
                    ...
                    .setOnClickListener(android.R.id.message, new FloatWindow.OnClickListener<TextView>() {
                        ...
                        @Override
                        public void onClick(final FloatWindow<?> floatWindow, TextView view) {
                            view.setText("不错，很听话");
                            floatWindow.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    floatWindow.cancel();
                                }
            ...
            FloatWindow.with(this)
                    ...
                    .setOnClickListener(R.id.tv_window_close, new FloatWindow.OnClickListener<TextView>() {
            ...
            XXPermissions.with(MainActivity.this)
                    ...
                    .request(new OnPermissionCallback() {
                        ...
                        public void onDenied(@NonNull List<String> permissions, boolean doNotAskAgain) {
                            FloatWindow.with(MainActivity.this)
                                    .setDuration(1000)
                                    .setContentView(R.layout.window_hint)
                                    .setImageDrawable(android.R.id.icon, R.drawable.ic_dialog_tip_error)
    ...
    public static void showGlobalWindow(Application application) {
        ...
        FloatWindow.with(application)
                ...
                .setOnClickListener(android.R.id.icon, new FloatWindow.OnClickListener<ImageView>() {

                    @Override
                    public void onClick(FloatWindow<?> floatWindow, ImageView view) {
                        Toaster.show("我被点击了");
                        // 点击后跳转到拨打电话界面
