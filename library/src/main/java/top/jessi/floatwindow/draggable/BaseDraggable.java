package top.jessi.floatwindow.draggable;
...
public abstract class BaseDraggable implements View.OnTouchListener {
    ...
    public int getViewWidth() {
        return mFloatWindow.getViewWidth();
    }
    ...
    public int getViewHeight() {
        return mFloatWindow.getViewHeight();
    }
    ...
    public void updateLocation(int x, int y, boolean allowMoveToScreenNotch) {
        ...
        int viewWidth = mFloatWindow.getViewWidth();
        int viewHeight = mFloatWindow.getViewHeight();
    ...
    public void updateWindowCoordinate(int x, int y) {
        WindowManager.LayoutParams params = mFloatWindow.getWindowParams();
        if (params == null) {
            return;
        }
    ...
    public Rect getSafeInsetRect() {
        Context context = mFloatWindow.getContext();
        Window window;
    ...
    protected void dispatchStartDraggingCallback() {
        ...
        mDraggingCallback.onStartDragging(mFloatWindow);
    }
    ...
    protected void dispatchExecuteDraggingCallback() {
        ...
        mDraggingCallback.onExecuteDragging(mFloatWindow);
    }
    ...
    protected void dispatchStopDraggingCallback() {
        ...
        mDraggingCallback.onStopDragging(mFloatWindow);
    }
    ...
    public interface DraggingCallback {
         ...
         * 开始拖拽
         */
        default void onStartDragging(FloatWindow<?> floatWindow) {}

        /**
         * 执行拖拽中
         */
        default void onExecuteDragging(FloatWindow<?> floatWindow) {}

        /**
         * 停止拖拽
         */
        default void onStopDragging(FloatWindow<?> floatWindow) {}
    }
}