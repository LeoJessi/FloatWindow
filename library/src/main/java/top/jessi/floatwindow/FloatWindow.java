...
import top.jessi.floatwindow.draggable.BaseDraggable;
...
public class FloatWindow<X extends FloatWindow<?>> implements Runnable,
    ...
    public interface OnClickListener<V extends View> {
         ...
         * 点击回调
         */
        void onClick(FloatWindow<?> floatWindow, V view);
    }
    ...
    public interface OnWindowLifecycle {
         ...
         * 窗口显示回调
         */
        default void onWindowShow(FloatWindow<?> floatWindow) {}

        /**
         * 窗口更新回调
         */
        default void onWindowUpdate(FloatWindow<?> floatWindow) {}

        /**
         * 窗口消失回调
         */
        default void onWindowCancel(FloatWindow<?> floatWindow) {}

        /**
         * 窗口回收回调
         */
        default void onWindowRecycle(FloatWindow<?> floatWindow) {}

        /**
         * 窗口可见性发生变化
         */
        default void onWindowVisibilityChanged(FloatWindow<?> floatWindow, int visibility) {}
    }
}